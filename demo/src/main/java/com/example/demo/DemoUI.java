...
import cz.miloslavbrada.ckeditor.server.CKEditorConfig;
...
public class DemoUI extends UI {
	...
	{ name: 'tools', items : [ 'Maximize', 'ShowBlocks','-','About' ] }
		...
		*/
        ...
        buttonsLayout.addComponent(new Button("Open Modal Subwindow", new Button.ClickListener() {
        ...
        buttonsLayout.addComponent(new Button("Open Non-Modal Subwindow with 100% Height", new Button.ClickListener() {
