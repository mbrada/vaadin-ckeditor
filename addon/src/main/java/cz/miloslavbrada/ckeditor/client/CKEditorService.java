...
public class CKEditorService {
	...
	private static List<ScheduledCommand> afterLoadedStack = new ArrayList<>();
	 ...
	 */
	public static native JavaScriptObject loadEditor(String id, CKEditorListener listener, String jsInPageConfig, int compWidth, int compHeight)
	/*-{
	 	// Build our inPageConfig object based on the JSON jsInPageConfig sent to us.
	 	var inPageConfig = @cz.miloslavbrada.ckeditor.client.CKEditorService::convertJavaScriptStringToObject(Ljava/lang/String;)(jsInPageConfig);
		...
		myEditor.on( 'instanceReady', function( ev ) {
    		ev.listenerData.@cz.miloslavbrada.ckeditor.client.CKEditorService.CKEditorListener::onInstanceReady()();
		}, null, listener);
	 ...
	 */
	public native static cz.miloslavbrada.ckeditor.client.CKEditor get(String id)
	/*-{
	...
	/*-{
	 	var styles = @cz.miloslavbrada.ckeditor.client.CKEditorService::convertJavaScriptStringToObject(Ljava/lang/String;)(jsStyles);
	...
	/*-{
	 	var definition = @cz.miloslavbrada.ckeditor.client.CKEditorService::convertJavaScriptStringToObject(Ljava/lang/String;)(jsDefinition);
