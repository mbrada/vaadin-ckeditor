...
public class CKEditor extends JavaScriptObject {
	...
	/*-{
	 	var rule = @cz.miloslavbrada.ckeditor.client.CKEditorService::convertJavaScriptStringToObject(Ljava/lang/String;)(jsRule);
	...
	/*-{
	    var regex = @cz.miloslavbrada.ckeditor.client.CKEditorService::convertJavaScriptStringToObject(Ljava/lang/String;)(regexString);
	...
	/*-{
	 	...
	 	this.on( 'blur', function( ev ) {
 			ev.listenerData.@cz.miloslavbrada.ckeditor.client.CKEditorService.CKEditorListener::onBlur()();
    	}, null, listener);
    	
	 	this.on( 'focus', function( ev ) {
 			ev.listenerData.@cz.miloslavbrada.ckeditor.client.CKEditorService.CKEditorListener::onFocus()();
    	}, null, listener);
    	
     	this.on( 'vaadinsave', function( ev ) {
	 		ev.listenerData.@cz.miloslavbrada.ckeditor.client.CKEditorService.CKEditorListener::onSave()();
    	}, null, listener);
    	
    	// hook into the change events for ckEditor
		this.on('change', function(ev) { 
			ev.listenerData.@cz.miloslavbrada.ckeditor.client.CKEditorService.CKEditorListener::onChange()();
		}, null, listener);

		this.on('selectionChange', function(ev) { 
			ev.listenerData.@cz.miloslavbrada.ckeditor.client.CKEditorService.CKEditorListener::onSelectionChange()();
		}, null, listener);
		this.on('contentDom', function(ev) {
			this.document.on('keyup', function(ev2) {
				ev2.listenerData.@cz.miloslavbrada.ckeditor.client.CKEditorService.CKEditorListener::onSelectionChange()();
		...
		this.on('mode', function(ev) { 
			ev.listenerData.@cz.miloslavbrada.ckeditor.client.CKEditorService.CKEditorListener::onModeChange(Ljava/lang/String;)(ev.editor.mode);
		}, null, listener);
		this.on('dataReady', function(ev) { 
			ev.listenerData.@cz.miloslavbrada.ckeditor.client.CKEditorService.CKEditorListener::onDataReady()();
		}, null, listener);
