// Copyright (C) 2010-2018 Yozons, Inc.
...
//
package cz.miloslavbrada.ckeditor.server;
...
public class VaadinCKEditorUI extends UI {
	...
	{ name: 'tools', items : [ 'Maximize', 'ShowBlocks','-','About' ] }
		...
		*/
		...
		resetTextButton1.addClickListener( new ClickListener() {
		...
		toggleReadOnlyButton1.addClickListener( new ClickListener() {
		...
		toggleViewWithoutEditorButton1.addClickListener( new ClickListener() {
		...
		toggleVisibleButton1.addClickListener( new ClickListener() {
		...
		resetTextButton2.addClickListener( new ClickListener() {
		...
		toggleReadOnlyButton2.addClickListener( new ClickListener() {
		...
		toggleViewWithoutEditorButton2.addClickListener( new ClickListener() {
		...
		toggleVisibleButton2.addClickListener( new ClickListener() {
